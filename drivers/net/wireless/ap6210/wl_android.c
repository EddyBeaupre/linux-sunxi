...
#define ANDROID_ERROR(...) do { if (android_msg_level & ANDROID_ERROR_LEVEL) { AP6210_ERR(__VA_ARGS__); } } while (0)
#define ANDROID_TRACE(...) do { if (android_msg_level & ANDROID_TRACE_LEVEL) { AP6210_ERR(__VA_ARGS__); } } while (0)
#define ANDROID_INFO(...)  do { if (android_msg_level & ANDROID_INFO_LEVEL) { AP6210_ERR(__VA_ARGS__); } } while (0)
